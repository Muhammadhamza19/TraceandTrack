...
function seeDetails()
  ...
  const handleSubmit = async (event) => {
    ...
    console.log(
      data.get('transporter_Name'),data.get('transporter_Id'),data.get('email')
    );

    await contract.methods.setTranDetails(data.get('transporter_Name'),data.get('transporter_Id'),data.get('email'))
